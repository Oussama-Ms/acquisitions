...
_This runs `scripts/dev.sh`, starting the backend on port 3000 and Neon Local proxy._
...
_The frontend will start on http://localhost:5173 and proxy API requests to port 3000._
